        ...
        <Flex w="5vw" h="100vh" bg="rgb(0,198,178)" justify="center" align="center" pt="15vh" direction="column" style={{position: 'fixed', top: 0, left: 0, minWidth: "60px"}}>
            <Flex h="100vh" justify="space-between" direction="column">
                ...
                <Button variant="transparent" title="Gruppenkalender" h="6vh" onClick={() => navigate(`/gruppenkalender/${userId}`)}>
                    <CalendarMonthIcon sx={{ fontSize: "47px", color: currentPath.includes("/gruppenkalender") ? 'rgb(249, 203, 0)' : 'rgb(256, 256, 256)'}}/>
                </Button>
                <Button variant="transparent" title="Hilfe" h="6vh" onClick={() => navigate(`/hilfe/${userId}`)}>
                    <HelpOutlineIcon sx={{ fontSize: "47px", color: currentPath.includes("/hilfe") ? 'rgb(249, 203, 0)' : 'rgb(256, 256, 256)'}}/>
                </Button>
            </Flex>
